...
processos, fracao_cpu = ler_processos("processoLista.txt")
escalonador_alternancia(processos, fracao_cpu, "processoLista.txt")

somaTrocas(processos)


# print(processos[0].trocasFIFO)
